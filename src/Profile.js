...
const Profile = () => {
  const user = {
    name: "Kim Patrick Baldesco",
    email: "kimpatrickx@gmail.com",
    birthdate: "March 29, 2000",
    address: "Cagayan De Oro City, Philippines",
    contactNumber: "09658305460",
    avatar: "https://via.placeholder.com/150/0000FF",
  };

  const carsSold = [
    { id: 1, model: "Toyota Corolla", price: "$15,000", date: "2025-09-10" },
    { id: 2, model: "Honda Civic", price: "$18,000", date: "2025-06-15" },
    { id: 3, model: "Ford Mustang", price: "$25,000", date: "2025-03-05" },
  ];

  const carsPending = [
    { id: 1, model: "Chevrolet Camaro", price: "$22,000", date: "2025-12-01" },
    { id: 2, model: "BMW X5", price: "$45,000", date: "2025-11-20" },
  ];
